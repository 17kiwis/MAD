...
class ViewController: UIViewController,UITextFieldDelegate {
    ...
    func updateTipTotals() {
        var amount:Float // amount=check amount
        var pct:Float //pct=tip percentage
        ...
        let numberOfPeople=Int(people.text!) //will returns an optional
        let tip=amount*pct
